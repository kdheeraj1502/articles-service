...
public class ArticlesController {
	...
	public ResponseEntity<List<ApiResponse>> getAllArticles(@RequestParam(defaultValue = "0") Integer pageNo,
	...
	public ResponseEntity<String> deleteAnArticles(@PathVariable String uuid) throws NotFoundError {
	...
	public ResponseEntity<ArticlesEntity> getAnArticles(@PathVariable String uuid) {
	 ...
	 */
	@GetMapping("/allTags")
	public ResponseEntity<List<TagsEntity>> getTags(@RequestParam(defaultValue = "0") Integer pageNo,
	...
	public ResponseEntity<String> updateTitleAndSlug(@PathVariable("id") int articleId, @RequestBody String title)
	...
	public ResponseEntity<ReadTime> getTimeToRead(@PathVariable String uuid) throws NotFoundError {
	...
	public ResponseEntity<List<TagsMetrics>> findTagCount(@RequestParam(defaultValue = "0") Integer pageNo,
			@RequestParam(defaultValue = "10") Integer pageSize) {
		List<TagsEntity> tagsList = getTags(pageNo, pageSize).getBody();
